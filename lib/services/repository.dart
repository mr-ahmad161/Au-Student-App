...
import 'package:aue/model/groups_response_model.dart';
...
import 'package:aue/model/payment_api_response.dart';
import 'package:aue/model/payment_request_model.dart';
...
class Repository {
  ...
  static Future<String> sendOTP(String studentId, String phoneNumber, int numOfDigits) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/SendOTP?StudentID=$studentId&PhoneNumber=$phoneNumber&NumOfDigits=$numOfDigits";

    try {
      String username = 'mobileuser';
      String password = 'Auedev2020';
      String basicAuth = 'Basic ' + convert.base64Encode(utf8.encode('$username:$password'));
      print(basicAuth);
  ...
  Future<PaymentApiResponse> postPaymentApi(PaymentRequestModel paymentRequestModel) async {
    // final parameters = {
    //   'action': 'SALE',
    //   'amount': {'currencyCode': 'AED', 'value': 71},
    //   'description': 'Finance',
    //   'language': 'en',
    //   'merchantAttributes': {}
    // };
    ...
    final result = await dio.post(
      ...
      data: paymentRequestModelToJson(paymentRequestModel),
      options: Options(
        receiveDataWhenStatusError: true,
      ),
    );

    return paymentApiResponseFromJson(convert.jsonEncode(result.data));
  }

  static Future<User> getStudentInformation(String studentId) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/Search?StudentID=$studentId";
...
//<<<<<<< HEAD
  static Future<StudentProfile> getStudentProfile(String studentId) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/GetProfile?StudentID=$studentId";
//=======
...
//>>>>>>> a26cb10c327e0b9fe51e9eacad8968c183335499
  ...
  Future<Announcements> getAnnouncements(String studentId) async {
    ...
    try {
      ...
      // print(result.data);
      final announcements = announcementsFromJson(convert.jsonEncode(result.data));
      return announcements;
    } catch (e) {
      print(e);
  ...
  Future<List<GrievanceHistory>> getGrievanceHistoryList(String studentId) async {
    final parameters = {"StudentID": studentId};
    ...
    try {
      final result = await dio.get(
        "GetGrievanceHistory",
        queryParameters: parameters,
        options: buildCacheOptions(const Duration(days: 7), forceRefresh: true, options: Options(receiveDataWhenStatusError: true)),
      );

      // print(result.data);
      final grievanceHistoryList = grievanceHistoryFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<GrievanceTermsAndConditions>> getGrievanceTermsAndConditions(String studentId, int functionalityId, int language) async {
    final parameters = {"StudentID": studentId, 'FunctionalityID': functionalityId, 'Language': language};
    ...
    try {
      ...
      // print(result.data);
      final grievanceTermsAndConditions = grievanceTermsAndConditionsFromJson(convert.jsonEncode(result.data));
  ...
  Future<GrievanceAcademicForm> getGrievanceAcademicForm(String studentId) async {
    final parameters = {
      "StudentID": studentId,
    };
    ...
    try {
      ...
      // print(result.data);
      final grievanceAcademicForm = grievanceAcademicFormFromJson(convert.jsonEncode(result.data));
  ...
  Future<GrievanceBehaviorForm> getGrievanceBehaviorForm(String studentId) async {
    final parameters = {
      "StudentID": studentId,
    };
    ...
    try {
      ...
      // print(result.data);
      final grievanceBehaviorForm = grievanceBehaviorFormFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<LetterRequest>> getLetterRequests(String studentId) async {
    ...
    try {
      ...
      // print(result.data);
      final letterRequests = letterRequestFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<AttendanceExcuse>> getAttendanceExcuseHistory(String studentId) async {
    final parameters = {"StudentID": studentId};
    ...
    try {
      ...
      // print(result.data);
      final attendanceExcuseHistory = attendanceExcuseFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<ExcusableAttendance>> getExcusableAttendance(String studentId, String startDate, String endDate) async {
    final parameters = {
      "StudentID": studentId,
      'DateFrom': startDate,
      'DateTo': endDate,
    ...
    try {
      ...
      // print(result.data);
      final excusableAttendance = excusableAttendanceFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<ExcuseCategory>> getExcuseCategories(String studentId) async {
    ...
    try {
      ...
      // print(result.data);
      final excuseCategories = excuseCategoryFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<NotificationModel>> getNotifications(String studentId) async {
    ...
    try {
      ...
      // print(result.data);
      final notifications = notificationFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<VideoTutorial>> getVideoTutorials(String studentId) async {
    ...
    try {
      ...
      // print(result.data);
      final videoTutorials = videoTutorialFromJson(convert.jsonEncode(result.data));
  ...
  Future<StudentRubric> getStudentRubric(String studentId, int courseWorkId, int rubricId) async {
    final parameters = {
    ...
    try {
      ...
      // print(result.data);
      final studentRubric = studentRubricFromJson(convert.jsonEncode(result.data));
  ...
  static Future<AnnouncementDetails> getAnnouncementDetails(int year, int id) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/GetAnnouncementDetails?Year=$year&ID=$id";
  ...
  static Future<List<Semester>> getSemesters(String studentId, int language) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/GetSemesters?StudentID=$studentId&Language=$language";
  ...
  static Future<List<SemesterDetails>> getSemesterDetails(String studentId, int semesterId) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/GetSemesterDetails?StudentID=$studentId&SemesterID=$semesterId";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print('Status 200');
        final List<SemesterDetails> semesterDetails = semesterDetailsFromJson(response.body);
  ...
  static Future<SentOtpModel> getSentOTPForVerification(String studentId) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/GetSentOTPForVerification?StudentID=$studentId";
  ...
  static Future<String> updateSentOTPStatus(String studentId, String sentOTP, bool isVerified) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/UpdateSentOTPStatus?StudentID=$studentId&SentOTP=$sentOTP&IsVerified=$isVerified";
  ...
  static Future<String> changeStudentPassword(String studentId, String newPassword) async {
    final String url = "https://integrations.aue.ae/stdsvc/Student/ChangeStudentPassword?StudentID=$studentId&NewPassword=$newPassword";
    try {
      String username = 'mobileuser';
      String password = 'Auedev2020';
      String basicAuth = 'Basic ' + convert.base64Encode(utf8.encode('$username:$password'));
...
//<<<<<<< HEAD
  ...
  static Future<String> changePhoneNumber(String studentId, String newPhoneNumber) async {
    String url = 'https://integrations.aue.ae/stdsvc/Student/ChangeStudentPhoneNumber?StudentID=$studentId&NewPhoneNumber=$newPhoneNumber';
  ...
  static Future<List<CourseCategories>> getCourseCategories({var studentId}) async {
    var url = "https://integrations.aue.ae/stdsvc/Student/GetCourseCategories?StudentID=$studentId";
//=======
...
//>>>>>>> a26cb10c327e0b9fe51e9eacad8968c183335499
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print("Categories Count: ${categories.courseCategoryList.length}");
  ...
  static Future<List<ClassUpdate>> getClassUpdates(String studentId) async {
    var url = "https://integrations.aue.ae/stdsvc/Student/GetClassUpdates?StudentID=$studentId";
  ...
  static Future<List<CoreCoursesObj>> getCoreCourses({var studentId, var categoryId}) async {
    var url = "https://integrations.aue.ae/stdsvc/Student/GetOfferedCourses?StudentID=$studentId&SemesterID=70&CourseCategoryID=$categoryId";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print("Courses Count: ${coreCourses.coreCoursesList.length}");
  ...
  static Future<bool> saveSelectedCourses() async {
    var url = "https://integrations.aue.ae/stdsvc/Student/SaveCourseRegistration";
  ...
  static Future<List<PaymentToPay>> getPaymentToPay({String studentId}) async {
    var url = "http://integrations.aue.ae/stdsvc/student/GetBalanceToPay?StudentID=$studentId";
  ...
  static Future<List<TermsCondition>> getTermsAndCondition() async {
    var url = "https://integrations.aue.ae/stdsvc/Student/GetTermsAndConditions?StudentID=191210021&FunctionalityID=1&Language=8";
  ...
  static Future<List<ElectiveColleges>> getElectiveColleges() async {
    var url = "https://integrations.aue.ae/stdsvc/Student/GetElectiveColleges?StudentID=151810021&ElectiveCategoryID=0&SemesterID=70";
  ...
  static Future<List<OfferedElectiveCourses>> getOfferedElectiveCorses({var studentId, var electiveCategoryId, var collegeId}) async {
    var url =
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print(json.decode(response.body));
        var jsonResponse = convert.jsonDecode(response.body);
        var offeredElectiveCourse = OfferedElectiveCoursesList.fromJson(jsonResponse);
        print("offered couurses count: ${offeredElectiveCourse.offeredElectiveCoursesList.length}");
  ...
  static Future<List<CourseTiming>> getCourseTimings({var studentId, var courseCode, var semesterId}) async {
    var url = "https://integrations.aue.ae/stdsvc/Student/GetCourseTimings?StudentID=$studentId&CourseCode=$courseCode&SemesterID=$semesterId";
  ...
  Future<List<ClassAnnouncement>> getClassAnnouncements({String studentId, int sectionId}) async {
    ...
    try {
      ...
      final announcements = classAnnouncementsFromJson(convert.jsonEncode(result.data));
      return announcements;
    } catch (e) {
      return Future.error(e);
    }
  ...
  Future<List<WhatsAppContact>> getWhatsAppContacts(String studentId) async {
    ...
    try {
      ...
      final whatsAppContacts = whatsAppContactFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<CourseOutline>> getCourseOutlines(String studentId, int sectionId) async {
    final parameters = {
      'StudentId': studentId,
      'SectionId': sectionId,
    };
    ...
    try {
      final result =
          await dio.get('GetCourseOutline', queryParameters: parameters, options: buildCacheOptions(const Duration(days: 7), forceRefresh: true));
      final courseOutlines = courseOutlineFromJson(convert.jsonEncode(result.data));
  ...
  Future<CourseWithdrawalData> getCourseWithdrawalData({String studentId, int sectionId}) async {
    final parameters = {'StudentID': studentId, 'SectionID': sectionId};
    ...
    try {
      ...
      final courseWithdrawalData = courseWithdrawalDataFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<CourseWithdrawalReason>> getCourseWithdrawalReasons() async {
    try {
      ...
      final courseWithdrawalReasons = courseWithdrawalReasonFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<ClassDiscussionModel>> getDiscussions(int sectionId) async {
    ...
    try {
      ...
      (result.data as List).forEach((element) => discussions.add(ClassDiscussionModel.fromMap(element)));
      return discussions;
    } catch (e) {
      return Future.error(e);
    }
  ...
  Future<LoadGroupMessagesModel> getGroupMessages({String studentId, String groupId, int scroll}) async {
    try {
      String username = 'mobileuser';
      String password = 'Auedev2020';
      String basicAuth = 'Basic ' + base64Encode(utf8.encode('$username:$password'));
      ...
      final result = await http.get(
        'https://integrations.aue.ae/chatapi/api/Chat/LoadGroupMessages?StudentID=$studentId&groupid=$groupId&scroll=$scroll',
        headers: headers,
      );
      if (result.statusCode == 200) {
        print(json.decode(result.body));
        final LoadGroupMessagesModel loadGroupMessagesModel = loadGroupMessagesModelFromJson(result.body);
        print('GroupsResponseModel');
        print(loadGroupMessagesModel?.toJson());
        return loadGroupMessagesModel;
      } else {
        return null;
      }
    } catch (e) {
  ...
  Future<void> addDiscussionReply(int discussionID, String reply, String replyBy) async {
    final parameters = {"DiscussionID": 3600, "ReplyText": reply, "ReplyBy": replyBy};
    final result = await dio.post(
      "AddDiscussionReply",
      data: parameters,
      options: buildCacheOptions(
  ...
  Future<dynamic> submitWithdrawalRequest(ApplyCourseWithdrawal model) async {
    final parameters = {
      ...
      'Attachments': model.attachments.map((Map<String, dynamic> attachment) {
        return {'StringValue': attachment['StringValue'], 'ByteValues': attachment['ByteValues']};
      }).toList()
    };
    print(parameters);
  ...
  Future<CourseSchedule> getStudentSchedule(User user) async {
    ...
    final parameters = {"StudentID": user.studentID, "SemesterID": currentSemester.semesterID, "DayID": 2};
...
//     final courses = Course.fromMapToList(result.data);
  ...
  Future<List<CourseMaterial>> getCourseMaterialList(Section section) async {
    ...
    try {
      ...
      final courseMaterials = courseMaterialFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<RubricCriteria>> gerRubricCriteriaList(int id, int rubricId, int courseWorkId) async {
    //TODO CHANGE THE IDS
    final parameters = {
      "ID": -1,
      "RubricID": rubricId,
...
//      "CourseWorkID": courseWorkId ?? 84128
    ...
    try {
      final result = await dio.get(
        "GetRubricCriteria",
        queryParameters: parameters,
        options: buildCacheOptions(Duration(days: 7), forceRefresh: true, options: Options(receiveDataWhenStatusError: true)),
      );

      final List<RubricCriteria> rubricCriteriaList = rubricCriteriaFromJson(jsonEncode(result.data));
  ...
  Future<List<RubricMeasurement>> getRubricMeasurement(int id, int rubricId) async {
    //TODO CHANGE THE IDS
    final parameters = {
      "ID": id ?? -1,
      "RubricID": rubricId ?? 2927,
    ...
    try {
      ...
      final List<RubricMeasurement> rubricMeasurement = rubricMeasurementFromJson(jsonEncode(result.data));
  ...
  Future<List<RubricDescriptor>> getRubricDescriptor(int id, int rubricId, int measurementId, int criteriaId) async {
    //TODO CHANGE THE IDS
    final parameters = {"ID": id ?? -1, "RubricID": rubricId ?? 2927, "MeasurementID": measurementId ?? 5963, "CriteriaID": criteriaId ?? -1};
    ...
    try {
      ...
      final List<RubricDescriptor> rubricDescriptor = rubricDescriptorFromJson(jsonEncode(result.data));
  ...
  Future<CourseMarks> getCourseMarks(String studentId, int sectionId) async {
    ...
    try {
      ...
      final CourseMarks courseMarks = courseMarksFromJson(jsonEncode(result.data));
  ...
  Future<List<ApplicableGrant>> getApplicableGrants(String studentId) async {
    ...
    try {
      ...
      final List<ApplicableGrant> _applicableGrants = applicableGrantFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<GrantHistory>> getGrantsHistory(String studentId) async {
    ...
    try {
      ...
      final List<GrantHistory> _grantsHistory = grantHistoryFromJson(convert.jsonEncode(result.data));
  ...
  Future<GrantDetails> getGrantDetails(String studentId, int discountTypeId, int subTypeId) async {
    final parameters = {
      "StudentID": studentId,
    ...
    try {
      ...
      final GrantDetails _grantDetails = grantDetailsFromJson(convert.jsonEncode(result.data));
  ...
  Future<GrantDetailsSemesterCompany> getGrantDetailsSemesterCompany(String studentId, int discountTypeId, int subTypeId) async {
    final parameters = {
      "StudentID": studentId,
      'DiscountTypeID': discountTypeId,
      'SubTypeID': subTypeId,
    ...
    try {
      ...
      final GrantDetailsSemesterCompany _grantDetails = grantDetailsSemesterCompanyFromJson(convert.jsonEncode(result.data));
  ...
  Future<GrantDetailsSemester> getGrantDetailsSemester(String studentId, int discountTypeId, int subTypeId) async {
    final parameters = {
      "StudentID": studentId,
      'DiscountTypeID': discountTypeId,
      'SubTypeID': subTypeId,
    ...
    try {
      ...
      final GrantDetailsSemester _grantDetails = grantDetailsSemesterFromJson(convert.jsonEncode(result.data));
  ...
  Future<GrantDetailsSemesterAlumni> getGrantDetailsSemesterAlumni(String studentId, int discountTypeId, int subTypeId) async {
    final parameters = {
      "StudentID": studentId,
      'DiscountTypeID': discountTypeId,
      'SubTypeID': subTypeId,
    ...
    try {
      ...
      final GrantDetailsSemesterAlumni _grantDetails = grantDetailsSemesterAlumniFromJson(convert.jsonEncode(result.data));
  ...
  Future<String> applyGrantSemesterCompany(ApplyGrantSemesterCompany applyGrantSemesterCompany, Function(int, int) onSendProgress) async {
    ...
    try {
      final result = await dio.post('ApplyGrantRequest',
          ...
          options: Options(receiveDataWhenStatusError: true), onReceiveProgress: (int count, int total) {
  ...
  Future<String> applyAcademicGrievance(ApplyAcademicGrievance applyAcademicGrievance, Function(int, int) onSendProgress) async {
  ...
  Future<StudentGrades> getStudentGrades(String studentId) async {
    ...
    try {
      ...
      final StudentGrades _studentGrades = studentGradesFromJson(convert.jsonEncode(result.data));
  ...
  Future<StudyPlan> getStudyPlan(String studentId) async {
    ...
    try {
      ...
      final StudyPlan _studyPlan = studyPlanFromJson(convert.jsonEncode(result.data));
  ...
  Future<List<Section>> getSections(User user) async {
    ...
    try {
      final result = await dio.get("GetAllSectionsByStudentID", queryParameters: parameters);
...
//    final Map<String, dynamic> parameters = {'SectionID': sectionID ?? 14397};
    try {
      ...
      Map<String, String> headers = {'content-type': 'application/json', 'accept': 'application/json', 'authorization': basicAuth};
      final result = await http.get('http://integrations.aue.ae/stdsvc/Student/GetSectionByID?SectionID=$sectionID', headers: headers);
      if (result.statusCode == 200) {
        print(json.decode(result.body));
        final SingleSection singleSection = SingleSection.fromJson(json.decode(result.body)[0]);
        print('SingleSection');
...
//      return singleSection;
  ...
  static Future<AttendanceSummary> getAttendanceSummary([String studentID, int sectionID]) async {
//    final Map<String, dynamic> parameters = {'SectionID': sectionID ?? 14397};
    try {
      String username = 'mobileuser';
      String password = 'Auedev2020';
      ...
      if (result.statusCode == 200) {
        print(json.decode(result.body));
        final AttendanceSummary attendanceSummary = attendanceSummaryFromJson(result.body);
  ...
  Future<CurrentSemester> getCurrentSemester(User user) async {
    if (user.currentSemester == null) {
      ...
      if (currentSemesterData.statusCode == HttpStatus.ok) {
        final currentSemester = CurrentSemester.fromMap(currentSemesterData.data);
  ...
  Future<GroupsResponseModel> getGroups({String studentId, String userType}) async {
    try {
      String username = 'mobileuser';
      String password = 'Auedev2020';
      String basicAuth = 'Basic ' + base64Encode(utf8.encode('$username:$password'));
      ...
      Map<String, String> headers = {'content-type': 'application/json', 'accept': 'application/json', 'authorization': basicAuth};
      final result = await http.get(
        'https://integrations.aue.ae/chatapi/api/Chat/GetGroups?StudentID=$studentId&UserType=$userType',
        headers: headers,
      );
      if (result.statusCode == 200) {
        print(json.decode(result.body));
        final GroupsResponseModel groupsResponseModel = groupsResponseModelFromJson(result.body);
        print('GroupsResponseModel');
        print(groupsResponseModel?.toJson());
  ...
  Future<List<Assignment>> getStudentAssignmentsBySectionID([String studentId = "181210060", int sectionId = 14397]) async {
    final parameters = {"StudentID": studentId, "SectionID": sectionId};
    print(parameters);
    try {
      final result = await dio.get(
        ...
        queryParameters: parameters,
        options: buildCacheOptions(const Duration(days: 7), options: Options(receiveDataWhenStatusError: true)),
      );
  ...
  Future<List<Event>> getEventsByType([int typeId = 0, bool activeOnly = false]) async {
