...
class _CoreCoursesState extends State<CoreCourses> {
  ...
  getCoreCourses() {
    ...
    Repository.getCoreCourses(studentId: studentId, categoryId: widget.courseCategoryId).then((value) {
      if (value.isNotEmpty) {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(width: 1, color: AppColors.primary.withOpacity(0.6)),
                ),
                child: Row(
