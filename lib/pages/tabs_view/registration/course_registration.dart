...
class _CourseRegistrationState extends State<CourseRegistration> {
  ...
  double getPercentage(int completedCredits, int requiredCredits) {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (c) => CoreCourses(
                                          categoryName: courseCategoryList[0].name,
                                          title: courseCategoryList[0].name,
                                          courseCategoryId: courseCategoryList[0].course_category_id,
                                          completedCreditHour: courseCategoryList[0].completed_credits,
                                          requiredCreditHour: courseCategoryList[0].required_credits,
                                          isGroupHeader: true,
                                        )));
                          },
                          child: ProgressCard(
                            title: courseCategoryList[0].name,
                            requiredCredits: courseCategoryList[0].required_credits,
                            completedCredits: courseCategoryList[0].completed_credits,
                            initialValue: this.getPercentage(courseCategoryList[0].completed_credits, courseCategoryList[0].required_credits),
                          ),
                        ),
                        InkWell(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (c) => CoreCourses(
                                          categoryName: courseCategoryList[1].name,
                                          title: courseCategoryList[1].name,
                                          courseCategoryId: courseCategoryList[1].course_category_id,
                                          completedCreditHour: courseCategoryList[1].completed_credits,
                                          requiredCreditHour: courseCategoryList[1].required_credits,
                                          isGroupHeader: false,
                                        )));
                          },
                          child: ProgressCard(
                            title: courseCategoryList[1].name,
                            requiredCredits: courseCategoryList[1].required_credits,
                            completedCredits: courseCategoryList[1].completed_credits,
                            initialValue: this.getPercentage(courseCategoryList[1].completed_credits, courseCategoryList[1].required_credits),
                          ),
                        ),
                      ],
                    ),
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (c) => CoreCourses(
                                          categoryName: courseCategoryList[2].name,
                                          title: courseCategoryList[2].name,
                                          courseCategoryId: courseCategoryList[2].course_category_id,
                                          completedCreditHour: courseCategoryList[2].completed_credits,
                                          requiredCreditHour: courseCategoryList[2].required_credits,
                                          isGroupHeader: false,
                                        )));
                          },
                          child: ProgressCard(
                            title: courseCategoryList[2].name,
                            requiredCredits: courseCategoryList[2].required_credits,
                            completedCredits: courseCategoryList[2].completed_credits,
                            initialValue: this.getPercentage(courseCategoryList[2].completed_credits, courseCategoryList[2].required_credits),
                          ),
                        ),
                        InkWell(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (c) => ElectiveCourses(
                                          completedCreditHour: courseCategoryList[3].completed_credits,
                                          requiredCreditHour: courseCategoryList[3].required_credits,
                                        )));
                          },
                          child: ProgressCard(
                              title: courseCategoryList[3].name,
                              requiredCredits: courseCategoryList[3].required_credits,
                              completedCredits: courseCategoryList[3].completed_credits,
                              initialValue: this.getPercentage(courseCategoryList[3].completed_credits, courseCategoryList[3].required_credits)),
                        ),
                      ],
                    ),
                  ],
