          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SecondaryTile(
                  onTap: () {
                    GroupsResponseModel groups = context.read<AppStateNotifier>().groupsResponseModel;
                    String mergeId = context.read<AppStateNotifier>().selectedSection?.mergeId;

                    if (groups.item2.firstWhere((element) => element.mergeId == mergeId).id != null) {
                      // Get.to(ClassDiscussionPage());
                      Get.to(ClassDiscussionReplies());
                    } else {
                      Fluttertoast.showToast(msg: 'No class discussion generated for this course yet!');
                    }
                  },
            ...
            if (snapshot.hasError && snapshot.error != null) {
              return CustomErrorWidget(
                err: DioError(
                    ...
                    response: Response<String>(data: 'Error fetching attendance summary'),
